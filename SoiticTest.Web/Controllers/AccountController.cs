...
using SoiticTest.Sessions;
using SoiticTest.Web.Controllers.Results;
using SoiticTest.Web.Models;
using SoiticTest.Web.Models.Account;
...
{
    public class AccountController : SoiticTestControllerBase
    {
